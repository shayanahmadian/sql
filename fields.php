            ...
            <table class="table table-striped table-hover rtl">
                ...
                <tbody class="text-center">
					<?php foreach ($fields as $key => $value) { 
						$url = "./fields.php?action=edit&id=" . $value['id'];
						?>
                        <tr>
                            <td><?= $value['id'] ?></td>
                            <td><?= $value['name'] ?></td>
...
<form method="post" action="./fields.php" style="display: none;">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body rtl text-right">
        <form method="post" action="./fields.php">
			...
			<input type="hidden" name="id" value="<?=$field_to_update['id']?>">

			<div class="form-group">
				<label>نام :</label>
				<input type="text" name="name" class="form-control"
					value="<?=$field_to_update['name']?>" 
					placeholder="نام را وارد کنید" required>
			</div>
